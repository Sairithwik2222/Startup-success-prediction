...
# Use Neon PostgreSQL directly OR environment variable if available
database_url = os.getenv(
    "DATABASE_URL",
    "postgresql://neondb_owner:npg_97wWtmAiLPJy@ep-billowing-breeze-af92skja.c-2.us-west-2.aws.neon.tech/neondb?sslmode=require"
)
