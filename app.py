...
def render_prediction_tool():
    ...
    if st.session_state.step == 1:
        ...
        importance_scores = [v['importance'] for v in top_features.values()]
        ...
        fig3.update_layout(
            ...
            yaxis=dict(tickfont=dict(color='#e0e0e0'), titlefont=dict(color='#e0e0e0')),
            height=400
        )
        ...
        if success_prob >= 70:
            st.success("""
            **Your startup shows high potential for success!** 
            ...
            st.warning("""
            **Your startup has moderate success potential.**
            
            Consider improving:
            - Strengthen your unique value proposition
            - Increase funding or revenue streams
            - Expand your team with key talent
            - Focus on customer acquisition and retention
            """)
        else:
            st.error("""
            **Your startup may face challenges.**
            
            Priority improvements:
            - Revisit your business model and market fit
            - Seek mentorship and advisory support
            - Strengthen your unique value proposition
            - Build stronger market presence in your region
            """)
